class UsersController < ApplicationController
  ...
  def addfriend
    ...
    if User.where("name LIKE ?", params[:addfriend][:friendname]) == nil or params[:addfriend][:friendname] == User.find_by_name(params[:id]) or User.find_by_name(params[:id]) == nil or User.find_by_name(params[:id]) == ""
      puts "friend doesn't exist or is self"
      return render 'layouts/friends/error.js.erb'
    end
    if User.where("user_id LIKE ? AND friend LIKE ?", params[:id], params[:addfriend][:friendname]) != nil
